    ...
    <Fragment>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" style={{'--background': "url('img/shop/product-1.jpg')"}}>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" style={{'--background': "url('img/shop/product-2.jpg')"}}>
                            <div class="product__label">
                                <span>Bánh mỳ</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" style={{'--background': "url('img/shop/product-3.jpg')"}}>
                            <div class="product__label">
                                <span>Bánh mỳ</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" style={{'--background': "url('img/shop/product-4.jpg')"}}>
                            <div class="product__label">
                                <span>Bánh mỳ</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" style={{'--background': "url('img/shop/product-5.jpg')"}}>
                            <div class="product__label">
                                <span>Cà phê</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" style={{'--background': "url('img/shop/product-6.jpg')"}}>
                            <div class="product__label">
                                <span>Cà phê</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" style={{'--background': "url('img/shop/product-7.jpg')"}}>
                            <div class="product__label">
                                <span>Cà phê</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" style={{'--background': "url('img/shop/product-8.jpg')"}}>
                            <div class="product__label">
                                <span>Cà phê</span>
                            </div>
                        </div>
                  ...
                  <div class="col-lg-6">
                      <div class="class__form">
                          <div class="section-title">
                              <span></span>
                              <h2>Về sản phẩm</h2>
                              <h5 style={{"text-align": "justify"}}>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</h5>
                          </div>
                          <div id="table1">
                              <table>
                                  <tr >
                          ...
                          <div>
                              <a href="https://shopee.vn/shop/55494347/" target="_blank" rel="noopener noreferrer">
                                <button type="submit" class="site-btn">Mua ngay</button>
                              </a>
                          </div>
                      </div>
                  </div>
              </div>
              <div class="class__video set-bg" style={{'--background': "url('img/Cake-product.png')"}}>
              </div>
          </div>
      </section>
      ...
      <section class="team spad">
          <div class="container">
              ...
              <div class="row">
                  <div class="col-lg-3 col-md-6 col-sm-6">
                      <div class="team__item set-bg" style={{'--background': "url('img/team/team-1.jpg')"}}>
                          <div class="team__item__text">
                              <h6>Lã Ngọc Anh</h6>
                              <span>Thợ làm bánh</span>
                              <div class="team__item__social">
                                  <a href="https://www.facebook.com/cantatacakecoffee" target="_blank" rel="noopener noreferrer"><i class="fa fa-facebook"></i></a>
                                  
                                  <a href="https://www.instagram.com/cantatacoffee_/" target="_blank" rel="noopener noreferrer"><i class="fa fa-instagram"></i></a>
                                  <a href="https://www.youtube.com/channel/UCtPIrX2a2A09hfmJ4hoEZzA" target="_blank" rel="noopener noreferrer"><i class="fa fa-youtube-play"></i></a>
                              </div>
                          </div>
                      </div>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm-6">
                      <div class="team__item set-bg" style={{'--background': "url('img/team/team-2.jpg')"}}>
                          <div class="team__item__text">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                      <div class="team__item set-bg" style={{'--background': "url('img/team/team-3.jpg')"}}>
                          <div class="team__item__text">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                      <div class="team__item set-bg" style={{'--background': "url('img/team/team-4.jpg')"}}>
                          <div class="team__item__text">
                              <h6>Lê Tuấn Hiệp</h6>
      ...
      <section class="instagram spad" id="instagram_home">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 p-0">
                    <div class="instagram__text">
                        ...
                        <a href="https://www.facebook.com/cantatacakecoffee" target="_blank" rel="noopener noreferrer">
                            <h5><i class="fa fa-facebook" ></i> Cantata Cake & Coffee</h5>
                        </a>
                        <a href="https://www.instagram.com/cantatacoffee_/" target="_blank" rel="noopener noreferrer">
                        	<h5><i class="fa fa-instagram" ></i> @cantatacoffee_</h5>
                        </a>
                        <div id="followus">  
                            <ul>
                                <li>    
      ...
      <div class="map">
        ...
        <div class="map__iframe">
            ...
            title="iframe-map" height="300" style={{border:0}} allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
      </div>
    </Fragment>
