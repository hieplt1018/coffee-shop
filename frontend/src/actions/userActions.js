...
export const register = (name, email, password, shippingInfo) => async(dispatch) => {
  try {
    ...
    const { data } = await axios.post('/api/v1/register', { name, email, password, shippingInfo } , config);
...
export const updateProfile = (name, email, shippingInfo) => async(dispatch) => {
  try {
    ...
    const { data } = await axios.put('/api/v1/me/update', { name, email, shippingInfo } , config);
